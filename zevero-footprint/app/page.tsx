...
import {
  computeElectricityEmissionsKg,
  computeHeatingEmissionsKg,
  computeFleetEmissionsKg,
  computeFlightsEmissionsKg,
  computeCommuteEmissionsKg,
  computeEquipmentEmissionsKg,
  runUnitTests,
